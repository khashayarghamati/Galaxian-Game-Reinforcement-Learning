...
class Agent:
    ...
    def act(self, state):
        ...
        # EXPLOIT
            ...
            print(f'action_values axis1 {torch.argmax(action_values, axis=2)[0]}')
            print(f'action_value  {(torch.argmax(action_values, axis=2)[0]).item()}')


            # print(f'action_values axis4 {torch.argmax(action_values, axis=4)}')
            action_idx = (torch.argmax(action_values, axis=2)[0]).item()
